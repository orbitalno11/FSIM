      ...
      if (showBanner) {
        if (this.props.title && (this.state.show === undefined || this.state.show)) {
          ...
          return _react2.default.createElement(
            "div",
            { key: "banner", className: "banner", style: this.props.css },
            this.renderImage(),
            this.renderTitle()
          );
        } else {
...
Banner.propTypes = {
  ...
  visibleTime: _propTypes2.default.number,
  image: _propTypes2.default.string,
  imageClase: _propTypes2.default.string,
  transitionAppearTime: _propTypes2.default.number,
  transitionTime: _propTypes2.default.number,
  showBanner: _propTypes2.default.bool
};
