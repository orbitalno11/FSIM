...
personal_header = ["รหัสนักศึกษา", "คะแนนเฉลี่ยตลอดหลักสูตร (GPAX)", "หลักสูตร", "ชื่อหน่วยงาน / บริษัท", "ปัจจุบันท่านมีภาวะการทำงานเป็นอย่างไร", "ชื่อตำแหน่งงาน", "เงินเดือน หรือรายได้เฉลี่ยต่อเดือน", "ชื่อสถาบันที่ท่านศึกษาต่อ", "คณะวิชา", "สาขาวิชาที่ศึกษาต่อ", "ท่านผ่านกิจกรรมฝึกงานในรูปแบบใด"]
data = pd.DataFrame()
...
#     if \
#     alumni_graduated.loc[alumni_graduated['branch_name'].str.contains(branch_name.split()[0]), ['branch_name']].shape[
#         0] > 0:
...
#                 ['alumni_id', 'status', 'company', 'institution', 'job_description', 'faculty', 'branch', 'salary']]
#
...
# working_table.loc[working_table['salary'] == "", ['salary']] = None
#
# out_function_data = {
